...
<head>
    ...
    <title>Face Heaven | Edit-Profile</title>
    ...
    <div class="container2">
        ...
        <div class="About">
            ...
            <ul>
                ...
                <li><input class="input" type="number" name="phonenumber" id="phonenumber" onkeypress="if(this.value.length==10) return false" value=
                <?php
            ...
            <ul>
                ...
                <li><input class="input" type="text" name="gender" value=
                <?php
            ...
            <hr>
            <input class="button" type = "submit"  onsubmit="return formValidation()">
        </div>
    </div>
    </form>
...
<script>
    ...
    function formValidation()
    {
        ...
        if(!phonenumber.value.match(/^[6-9][0-9]{9}$/))
        {
             alert("Phone number should be of 10 digit starting should be from 6,7,8,9");
             phonenumber.focus();
            return false;
        }

        //checking pincode validation
         if(!pincode.value.match(/^[11-90][0-9]{5}$/))
         {
            alert("Enter valid 6 digit pincode of india");
            pincode.focus();
            return false;
         }
    }
            ...
            <div class="footer-row">
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="product.htmls">ALL PRODUCT</a></li>

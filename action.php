...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		...
		$sql = "SELECT * FROM product WHERE meta_keyword LIKE '%$keyword%'";
	}
			...
			echo "<form method='post' action='login_new.html'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="/ecommerce_final/payment_success.php" method="get">
						...
						'<div class="row" style="display: flex;align-items: center; margin: 2%; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
								<div class="col-md-2">
									<div class="btn-group">
										...
										<a href="#" update_id_wish="'.$product_id.'" class="btn btn-primary update2"><span class="glyphicon glyphicon-ok-sign"></span></a>
									</div>
								</div>
								<input type="hidden" name="product_id[]" value="'.$product_id.'"/>
								<input type="hidden" name="" value="'.$cart_item_id.'"/>

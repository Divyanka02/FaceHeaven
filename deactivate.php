...
<div class="box">
    ...
    <div class="container2">
       ...
       <div class="About">
           <ul class="ul">               
       <p class="ques">Are you sure you want to deactivate your account?
               <!--<button type="button" class="button" onclick="window.location.href='deleteProfile.php'">Continue</button>-->
